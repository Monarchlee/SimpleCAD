...
public class Mouse : MonoBehaviour
{
    ...
    [SerializeField] static public float radius = 0;
    [SerializeField] static public float strength = 0;
    [SerializeField] static public float damping = 0;
    [SerializeField] static public bool iseraser = false;
    [SerializeField] static public int shape = 0;    //sphere:0 cube:1

    static public bool mirror_x = false;
    static public bool mirror_y = false;
    static public bool mirror_z = false;
